...
namespace Reaperpointmod
{
    internal class ReaperpointmodMissionReward
    {
        ...
        public static void ReaperMissionReward()
        {
            ...
            AnuHavenDefend.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Supplies,
                Value = ReaperMissionRewardConfig.AnuDefHavenSuppliesValue + 308
            };
            AnuHavenDefend.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.AnuDefHavenMaterialsValue
            };
            AnuHavenDefend.Resources[2] = new ResourceUnit
            {
                Type = ResourceType.Tech,
                Value = ReaperMissionRewardConfig.AnuDefHavenTechValue
            };

            NJHavenDefend.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Supplies,
                Value = ReaperMissionRewardConfig.NJDefHavenSuppliesValue
            };
            NJHavenDefend.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.NJDefHavenMaterialValue + 1715
            };
            NJHavenDefend.Resources[2] = new ResourceUnit
            {
                Type = ResourceType.Tech,
                Value = ReaperMissionRewardConfig.NJDefHavenTechValue
            };
            SynedHavenDefend.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Supplies,
                Value = ReaperMissionRewardConfig.SynDefHavenSuppliesValue
            };
            SynedHavenDefend.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.SynDefHavenMaterialValue
            };
            SynedHavenDefend.Resources[2] = new ResourceUnit
            {
                Type = ResourceType.Tech,
                Value = ReaperMissionRewardConfig.SynDefHavenTechValue + 678
            };
            AncientChystalLiving.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.LivingCrystalMaterialsValue
            };
            AncientChystalLiving.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.LivingCrystals,
                Value = ReaperMissionRewardConfig.LivingCrystalValue
            };
            AncientOrichalcum.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.OrichalciumMaterialsValue
            };
            AncientOrichalcum.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.Orichalcum,
                Value = ReaperMissionRewardConfig.OrichalciumValue
            };
            AncientProteanMutagen.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Materials,
                Value = ReaperMissionRewardConfig.ProteanMutagenMaterilasValue
            };
            AncientProteanMutagen.Resources[1] = new ResourceUnit
            {
                Type = ResourceType.ProteanMutane,
                Value = ReaperMissionRewardConfig.ProteanMutagenValue
            };
            AncientRefinery.Resources[0] = new ResourceUnit
            {
                Type = ResourceType.Materials,
