...
namespace Reaperpointmod
{
	...
	/// </summary>
	public class ReaperpointmodMain : ModMain
	{
		...
		public static ReaperpointmodMain Main { get; private set; }

		public new ReaperpointmodConfig Config => (ReaperpointmodConfig)base.Config;
