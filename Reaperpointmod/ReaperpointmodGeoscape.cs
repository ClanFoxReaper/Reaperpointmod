...
namespace Reaperpointmod
{
	...
	public class ReaperpointmodGSInstanceData
	{
	...
	/// </summary>
	public class ReaperpointmodGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new ReaperpointmodGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			ReaperpointmodGSInstanceData data = (ReaperpointmodGSInstanceData)instanceData;
		}
