...
- ReaperpointmodConfig.cs: Example of ModConfig for custom mod settings;
- ReaperpointmodGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ReaperpointmodMain.cs: Main mod class, recieves mod management and general events;
- ReaperpointmodTactical.cs: Example of ModTactical for modifying tactical level;
